...
const Print_most_borrowed_class = () => {
    ...
    console.log("This URL: /admin/analytics/most_borrowed_book_classifications?date=${default4_Date}");
    ...
    return (
      <div className="bg-white h-auto w-full text-black text-center mx-auto p-5">
        ...
        <div className="h-[700px] w-[700px] mx-auto text-center p-10 page">
          <h1 className="font-bold">Most Borrowed Books Based on Classifications</h1>
