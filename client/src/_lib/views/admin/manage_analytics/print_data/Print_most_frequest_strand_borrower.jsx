          ...
          <div className="h-[auto] w-[700px] mx-auto -mt-11  p-10 page">
            ...
            <div>
              <p className="text-center mt-5">
                The report titled "Most Frequent Section Borrower" displays data
                on the borrowing activity of various academic sections. Each
                section—ICT-401, STEM-401, HUMMS-301, ABM-402, and GAS-401—has
                borrowed one item, representing 20.00% of the total borrowing
                activity. The data suggests an equal borrowing frequency across
                all sections, with no single section dominating the borrowing
                statistics. This distribution indicates that borrowing
                activities are evenly distributed among the sections included in
                the report.
              </p>
            </div>
            ...
            <div className="bg-white w-full h-auto">
              <p class="border-t border-black pt-2 absolute   text-center w-[250px] -ml-35 mt-[200px]">
                <span className="text-sm">
                  Signature of the Head Librarian Over Printed Name
                </span>
              </p>

              <p className="border-t border-black pt-2 absolute w-[250px]   ml-[350px] mt-[200px]">
