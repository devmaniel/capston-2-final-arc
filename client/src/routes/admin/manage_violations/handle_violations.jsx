...
import Handle_violations_page from "../../../_lib/views/admin/manage_violations/handle_violations_page";
...
export const Route = createFileRoute(
  ...
  validateSearch: (search) => {
    ...
    return {
      violations_id: search.violations_id,
    };
  },
  beforeLoad: async ({ search }) => {
    // Validate violations_id is not null or undefined
    if (!search.violations_id) {
      throw redirect({
  ...
  component: () => <Handle_violations_page />,
});
