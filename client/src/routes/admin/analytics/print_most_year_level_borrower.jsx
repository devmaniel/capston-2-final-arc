...
import Print_most_year_level_borrower from '../../../_lib/views/admin/manage_analytics/print_data/Print_most_year_level_borrower'


import auth from '../../../_lib/api/auth';

export const Route = createFileRoute('/admin/analytics/print_most_year_level_borrower')({
  beforeLoad: async () => {
    const role = "admin";
  ...
  component: () => <Print_most_year_level_borrower/>
})