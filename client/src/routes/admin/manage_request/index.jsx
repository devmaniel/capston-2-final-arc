...
import Manage_request_index from '../../../_lib/views/admin/manage_request/manage_request_index'


import auth from "../../../_lib/api/auth";

export const Route = createFileRoute('/admin/manage_request/')({
  beforeLoad: async () => {
    const role = "admin";
  ...
  component: () => <Manage_request_index />
})