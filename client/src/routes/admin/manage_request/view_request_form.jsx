...
import View_Request_Page from '../../../_lib/views/admin/manage_request/View_Request_Page'

import auth from "../../../_lib/api/auth";

export const Route = createFileRoute('/admin/manage_request/view_request_form')({
  beforeLoad: async () => {
    const role = "admin";
